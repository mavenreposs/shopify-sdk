...
public class ShopifyEndpoint {
    ...
    public static final String UPDATED_AT_MAX_QUERY_PARAMETER = "updated_at_max";
    public static final String ATTRIBUTION_APP_ID_QUERY_PARAMETER = "attribution_app_id";
    public static final String IDS_QUERY_PARAMETER = "ids";
    public static final String SINCE_ID_QUERY_PARAMETER = "since_id";
    public static final String QUERY_QUERY_PARAMETER = "query";
